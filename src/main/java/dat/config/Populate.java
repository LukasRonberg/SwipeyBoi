...
public class Populate {
    ...
    private static Set<EventGroup> getSkydiveEventGroups() {
        ...
        EventGroup r103 = new EventGroup(103, 2520.0, LocalDate.of(2024, 1, 4), LocalTime.of(13, 0));
        EventGroup r104 = new EventGroup(104, 3200.0, LocalDate.of(2024, 1, 5), LocalTime.of(14, 0));
        EventGroup r105 = new EventGroup(105, 4500.0, LocalDate.of(2024, 1, 6), LocalTime.of(15, 0));
    ...
    private static Set<EventGroup> getHikeEventGroups() {
        ...
        EventGroup r114 = new EventGroup(114, 2520.0, LocalDate.of(2024, 2, 4), LocalTime.of(13, 0));
        EventGroup r115 = new EventGroup(115, 3200.0, LocalDate.of(2024, 2, 5), LocalTime.of(14, 0));
        EventGroup r116 = new EventGroup(116, 4500.0, LocalDate.of(2024, 2, 6), LocalTime.of(15, 0));
